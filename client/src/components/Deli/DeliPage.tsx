...
const DeliPage: React.FC = () => {
  ...
  const initialMilk = [
    ...
    { 
      name: "משקה קפה 25 PRO עם חלבון חלב ", 
    ...
    { 
      name: "משקה וניל פרו Pro ", 
      image: importImage('vanilla_protein_drink_pro.jpeg'), 
      id: 4,
    },
    { 
      name: " חלב PRO שיבולת שועל ובננה", 
  ...
  const initialYogurtdelicacies = [
    { name: " יוגורט פצפוצי שוקולד", image: importImage('muller_mix_chocolate_flakes.jpeg'), id: 4 },
    { name: " יוגורט בוטנים ושקדים מקורמלים", image: importImage('bio_mixed_peanuts_almonds.jpeg'), id: 4 },
    { name: " יוגורט קורנפלקס מצופה שוקולד", image: importImage('muller_mix_choco_cornflakes.jpeg'), id: 4 },
    { name: " יוגורט גליליות מילוי קרם", image: importImage('muller_mix_cream_rolls.jpeg'), id: 4 },
    { name: " יוגורט  כדורים מצופים שוקולד חום לבן", image: importImage('bio_choco_balls.jpeg'), id: 4 },
    { name: " יוגורט גרעינים אגוזים וחמוציות", image: importImage('bio_nuts_berries.jpeg'), id: 4 },
    { name: "יוגורט שבבי פקאן מסוכרים מצופים שוקולד", image: importImage('pecan_choco_yogurt.jpeg'), id: 4 },
    { name: "יוגורט פצפוצי שוקולד", image: importImage('choco_flakes_yogurt.jpeg'), id: 4 },
    { name: "יוגורט תות קורנפלקס מצופה שוקולד חלב", image: importImage('strawberry_choco_cornflakes.jpeg'), id: 4 },
    { name: "יוגורט אגוזי לוז ושקדים בקרמל מלוח", image: importImage('hazelnuts_almonds_caramel_yogurt.jpeg'), id: 4 },
    { name: "יוגורט דנונה ", image: importImage('danone_multi_3_percent.jpeg'), id: 4 },
    { name: "יוגורט דנונה  עם צ'יה ", image: importImage('danone_chia_3_percent.jpeg'), id: 4 },
    { name: "יוגורט דנונה ביו 3% ", image: importImage('danone_bio_3_percent.jpeg'), id: 4 },
    { name: "יוגורט דנונה ביו 1.7% ", image: importImage('danone_bio_1.7_percent.jpeg'), id: 4 },
    { name: "יוגורט דנונה ביו 0% ", image: importImage('danone_bio_0_percent.jpeg'), id: 4 },
    { name: "מארז 8 יחידות יוגורט דנונה ביו 3% ", image: importImage('8_pack_danone_bio_3_percent.jpeg'), id: 4 },
    { name: "מארז 8 יחידות יוגורט דנונה ביו 1.7% ", image: importImage('8_pack_danone_bio_1.7_percent.jpeg'), id: 4 },
    { name: "יוגורט יווני", image: importImage('greek_style_yogurt.jpeg'), id: 4 },
    { name: "יוגורט פרוביוטי דל לקטוז", image: importImage('probiotic_lactose_free_yogurt.jpeg'), id: 4 },
    { name: "יוגורט במתיקות מעודנת ללא תוספת סוכר- מארז 8 יח", image: importImage('8_pack_sugar_free_2_percent_yogurt.jpeg'), id: 4 },
    { name: "יוגורט  אפרסק 3%", image: importImage('peach_yogurt_3_percent.jpeg'), id: 4 },
    { name: "יוגורט  פירות יער ", image: importImage('berry_yogurt_3_percent.jpeg'), id: 4 },
    { name: "יוגורט  תות ", image: importImage('strawberry_yogurt_3_percent.jpeg'), id: 4 },
    { name: "מארז 8 יוגורט תות ", image: importImage('8_pack_strawberry_yogurt_3_percent.jpeg'), id: 4 },
    { name: "מארז 8 יוגורט Greek בסגנון יווני ", image: importImage('8_pack_greek_yogurt_6.5_percent.jpeg'), id: 4 },
    { name: "דנונה  יוגורט  לימון", image: importImage('skyr_lemon_creme_yogurt.jpeg'), id: 4 },
    { name: "דנונה יוגורט  תות", image: importImage('skyr_strawberry_yogurt.jpeg'), id: 4 },
    { name: "יוגורט PRO פרו 20 גרם חלבון", image: importImage('pro_yogurt_1.5_percent_20g_protein.jpeg'), id: 4 },
    { name: "יוגורט PRO  תות  20 גרם חלבון", image: importImage('pro_yogurt_strawberry_0_percent_20g_protein.jpeg'), id: 4 },
    { name: "יוגורט PRO  אפרסק 20 גרם חלבון", image: importImage('pro_yogurt_peach_0_percent_20g_protein.jpeg'), id: 4 },
    { name: "יוגורט PRO  וניל , 20 גרם חלבון", image: importImage('pro_yogurt_vanilla_0_percent_20g_protein.jpeg'), id: 4 },
    { name: "יוגורט PRO  פירות יער  20 גרם חלבון", image: importImage('pro_yogurt_berry_0_percent_20g_protein.jpeg'), id: 4 },
    { name: "יוגורט PRO  21 גרם חלבון", image: importImage('pro_yogurt_plain_0_percent_21g_protein.jpeg'), id: 4 },
    { name: "יוגורט PRO  תות 20 גרם חלבון", image: importImage('pro_yogurt_strawberry_0_percent_sugar_20g_protein.jpeg'), id: 4 },
    { name: "יוגורט PRO  מנגו ואפרסק ", image: importImage('pro_yogurt_mango_peach_0_percent_sugar.jpeg'), id: 4 },
